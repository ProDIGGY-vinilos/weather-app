		...
		<div className={styles.container}>
			<form onSubmit={handleSubmit(onSubmit)} className={styles.formContainer}>
				<div className={styles.fields}>
					...
					<div className={styles.formInput}>
						<select name='country' placeholder='Country' {...register('country')} required>
							<option disabled selected value='' className={styles.placeholder}>
								Select Country
							</option>
			...
			<div className={styles.weatherContainer}>
				{isLoaded ? <WeatherDetails showWeather={weatherData} /> : <p>Please insert location</p>}
			</div>
		</div>
	);
};
